...
static void bench_spmv_double_taco(benchmark::State& state) {
...
TACO_BENCH(bench_spmv_double_taco)->ArgsProduct({benchmark::CreateDenseRange(100, 2500, 200), benchmark::CreateDenseRange(2, 2, 1)});
