...
static void bench_spmv_double_gsl(benchmark::State& state) {
...
TACO_BENCH(bench_spmv_double_gsl)->ArgsProduct({benchmark::CreateDenseRange(100, 2500, 200), benchmark::CreateDenseRange(2, 2, 1)});
