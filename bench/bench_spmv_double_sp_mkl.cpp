...
static void bench_spmv_double_sp_mkl(benchmark::State& state, float SPARSITY, int dim) {
...
TACO_BENCH_ARGS(bench_spmv_double_sp_mkl, 0.00078125, 0.00078125, DIM_SIZE);
TACO_BENCH_ARGS(bench_spmv_double_sp_mkl, 0.0015625, 0.0015625, DIM_SIZE);
TACO_BENCH_ARGS(bench_spmv_double_sp_mkl, 0.003125, 0.003125, DIM_SIZE);
TACO_BENCH_ARGS(bench_spmv_double_sp_mkl, 0.00625, 0.00625, DIM_SIZE);
TACO_BENCH_ARGS(bench_spmv_double_sp_mkl, 0.0125,  0.0125, DIM_SIZE);
TACO_BENCH_ARGS(bench_spmv_double_sp_mkl, 0.025,   0.025, DIM_SIZE);
TACO_BENCH_ARGS(bench_spmv_double_sp_mkl, 0.05,    0.05, DIM_SIZE);
TACO_BENCH_ARGS(bench_spmv_double_sp_mkl, 0.1,     0.1, DIM_SIZE);