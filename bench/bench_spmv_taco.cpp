...
static void bench_spmv_taco(benchmark::State& state) {
    ...
    generateData += " --nnz 0.5 --out_dir /home/ubuntu/mosaic/data/spdata/";
    exec(generateData.c_str());
    std::string filename = "/home/ubuntu/mosaic/data/spdata/spmv/B_" + std::to_string(dim) + "_0.5.mtx";
  ...
  std::string eraseData = "rm -rf /home/ubuntu/mosaic/data/spdata/spmv/B_" + std::to_string(dim) + "_0.5.mtx";
  exec(eraseData.c_str());
}

TACO_BENCH(bench_spmv_taco)->DenseRange(800, 800, 800);
