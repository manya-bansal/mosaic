...
TACO_BENCH_ARGS(bench_sddmm_varySparisty_dot_blas, 0.00078125, 0.00078125, DIM_SIZE);
TACO_BENCH_ARGS(bench_sddmm_varySparisty_dot_blas, 0.0015625, 0.0015625, DIM_SIZE);
TACO_BENCH_ARGS(bench_sddmm_varySparisty_dot_blas, 0.003125, 0.003125, DIM_SIZE);
