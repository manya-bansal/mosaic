...
TACO_BENCH_ARGS(bench_sddmm_varySparisty_mkl, 0.00078125, 0.00078125, DIM_SIZE);
TACO_BENCH_ARGS(bench_sddmm_varySparisty_mkl, 0.0015625,  0.0015625, DIM_SIZE);
TACO_BENCH_ARGS(bench_sddmm_varySparisty_mkl, 0.003125,   0.003125, DIM_SIZE);
