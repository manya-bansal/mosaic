...
void set_up_mkl_int(int dim, float * A_vals, float * b_vals, float){
    MKL_INT v2422 = dim;
    MKL_INT v2421 = 1;
    float zero = 0;
    float v2420 = 1;
    sgemv("n", &v2422, &v2422, &v2420, A_vals, &v2422, b_vals, &v2421, &zero, b_vals, &v2421);
}
 void set_up_mkl_float(float * arg, float val){
     *arg = val;}
#endif
